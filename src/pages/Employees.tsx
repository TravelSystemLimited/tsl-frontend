...
const Employees = () => {
  ...
  return (
    <div className=" min-h-screen bg-[#f8f7f7] p-[0px] md:p-6 mt-16">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          <SidebarTrigger className="text-[#8C6D73]" />
          <div className='' >
  <h1 className="text-2xl md:text-3xl font-bold text-[#3b3b3b]">Employee Management</h1>
